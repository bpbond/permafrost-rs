...
dat_filtered %>% 
  mutate(ERA5_Tair_anomaly = ERA5_Tair - ERA5_Tair_mean,
    ...
    select(sqrt_Rs_annual, sqrt_Rh_annual, sqrt_Rs_growingseason,
           ...
           Year, Latitude, Longitude, SRDB_leaf_habit, SRDB_ecosystem_type = Ecosystem_type,
           # ERA5 data
...
dat_base_global |> 
  ...
  na.omit() ->
  dat_base_global_Rs_annual

rf_all_data <- ranger(sqrt_Rs_annual ~ ., 
                      data = dat_base_global_Rs_annual, 
                      importance = "impurity")
print(rf_all_data)

dat_base_global_Rs_annual |> 
  mutate(sqrt_Rs_annual_pred = predict(rf_all_data, data = dat_base_global_Rs_annual)$predictions) |> 
...
# Top three variables...
pdpVars(data = dat_base_global_Rs_annual, 
        fit = rf_all_data, 
